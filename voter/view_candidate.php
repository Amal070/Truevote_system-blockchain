...
$election_id = isset($_GET['election_id']) && is_numeric($_GET['election_id']) ? (int)$_GET['election_id'] : null;

if ($election_id) {
    // Fetch specific election
    $electionStmt = $pdo->prepare("SELECT * FROM elections WHERE id = ?");
...
<!-- ✅ Page-specific styles AFTER header -->
<style>
                    ...
                    <div class="candidates-grid">
                        <?php foreach ($candidates as $c): ?>
                            ...
                            <div class="candidate-card">
                                <?php if($c['photo']): ?>
                                    <img src="../<?= htmlspecialchars($c['photo']) ?>" alt="Photo of <?= htmlspecialchars($c['name']) ?>">
                                <?php else: ?>
